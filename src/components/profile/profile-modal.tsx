    ...
    <div className="group relative">
      ...
      <div className="relative">
        <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
          <Icon className="h-4 w-4 text-gray-400 transition-colors group-focus-within:text-gray-500" />
        </div>
        <input
          type={type}
          value={value}
          ...
          className={cn(
            ...
            "focus:border-gray-500 focus:ring-4 focus:ring-gray-500/10 focus:outline-none",
