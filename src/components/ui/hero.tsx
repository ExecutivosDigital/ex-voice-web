        ...
        <div className="flex h-full w-full flex-col gap-4 pt-20 xl:flex-row xl:items-center">
          <div className="flex flex-1 flex-col gap-2 p-4 xl:gap-4 2xl:p-0">
            ...
            <button className="group relative hidden w-max xl:block">
              ...
              <span className="bg-primary text-light relative inline-flex w-full items-center justify-center rounded-lg px-4 py-2 text-lg font-bold transition-all duration-200 focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none">
                Quero Conhecer
