    ...
    return (
        <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-white/80 backdrop-blur-md">
            ...
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
                ...
                <div className="absolute top-1/4 left-1/4 h-[300px] w-[300px] rounded-full bg-gray-400/5 blur-[100px]" />
                <div className="absolute bottom-1/4 right-1/4 h-[300px] w-[300px] rounded-full bg-gray-400/5 blur-[100px]" />
            </div>
        </div>
    );
}
