          ...
          <div className="p-4">
            <DayPicker
              ...
              classNames={{
                ...
                cell: "text-center text-sm p-0 relative [&:has([aria-selected])]:bg-gray-50 first:[&:has([aria-selected])]:rounded-l-lg last:[&:has([aria-selected])]:rounded-r-lg focus-within:relative focus-within:z-20",
                ...
                day_selected:
                  "bg-gradient-to-br from-primary to-black text-white shadow-md shadow-black/20 hover:opacity-90 hover:shadow-lg hover:shadow-black/30",
                day_today:
