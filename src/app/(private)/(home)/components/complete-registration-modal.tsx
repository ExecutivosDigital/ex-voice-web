                ...
                <div className="relative hidden w-1/2 md:block overflow-hidden bg-gray-900">
                    ...
                    <div className="absolute top-10 left-10 z-20">
                        <div className="flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-md border border-white/20">
                            <div className="h-2 w-2 rounded-full bg-gray-400 animate-pulse shadow-[0_0_8px_rgba(96,165,250,0.8)]" />
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                    ...
                                    render={({ field, fieldState }) => (
                                        <FormItem>
                                            <Field
                                                ...
                                                name="name"
                                                autoComplete="name"
                                                Svg={<User className="text-gray-400" size={20} />}
                                                value={field.value}
                                    ...
                                    render={({ field, fieldState }) => (
                                        <FormItem>
                                            <Field
                                                ...
                                                autoComplete="tel"
                                                inputMode="tel"
                                                Svg={<Phone className="text-gray-400" size={20} />}
                                    ...
                                    render={({ field, fieldState }) => (
                                        <FormItem>
                                            <Field
                                                ...
                                                name="cpf"
                                                inputMode="numeric"
                                                Svg={<Hash className="text-gray-400" size={20} />}
                                                value={field.value}
                                                onChange={(e: any) =>
                                ...
                                <div className="pt-6">
                                    ...
                                    <p className="mt-6 text-center text-xs text-slate-400 font-medium">
                                        Ao continuar, você aceita nossos <span className="text-gray-600 cursor-pointer hover:underline font-semibold">Termos de Uso</span> e <span className="text-gray-600 cursor-pointer hover:underline font-semibold">Política de Privacidade</span>.
                                    </p>
                                </div>
                            </form>
                        </Form>
