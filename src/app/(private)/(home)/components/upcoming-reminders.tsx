                            ...
                            <motion.div
                                ...
                                className={cn(
                                    ...
                                    reminder.status === "pending"
                                        ? "border-transparent bg-gray-50/80 hover:border-gray-100 hover:bg-white hover:shadow-sm"
                            ...
                            >
                                ...
                                <div className="relative shrink-0">
                                    {editingId === reminder.id ? (
                                        <div
                                            ref={timeInputRef}
                                            className="absolute -left-1 -top-1 z-10 flex items-center gap-1 rounded-lg border border-gray-200 bg-white p-1 shadow-lg"
                                        >
                                            <input
                                                type="time"
                                                value={tempTime}
                                            ...
                                            <button
                                                ...
                                                className="rounded bg-gray-500 p-0.5 text-white hover:bg-gray-600"
                                            >
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                reminder.status === 'pending'
                                                    ? "bg-white text-gray-600 shadow-sm ring-1 ring-gray-200 group-hover:text-gray-600 group-hover:ring-gray-200"
                                                    : reminder.status === 'completed'
