    ...
    <div className="flex w-full flex-col gap-8 pb-10">
      ...
      <div className="flex w-full flex-col gap-2">
        ...
        <div className="mt-2 flex gap-4 text-xs text-gray-400">
          ...
          {recording?.specificSummary && <span className="text-gray-600">✓ Specific Summary</span>}
        </div>
      </div>
      ...
      {specificSummary ? (
        <div className="flex w-full flex-col gap-4">
          <div className="flex items-center gap-3 border-b border-gray-200 pb-4">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-r from-neutral-500 to-neutral-900 text-white shadow-md">
              <svg
                className="h-5 w-5"
                fill="none"
                stroke="currentColor"
