      ...
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-3xl border border-gray-200/70 bg-white/80 px-4 py-3 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex h-8 items-center gap-1.5 rounded-full bg-gradient-to-r from-primary to-primary-dim px-3.5 text-[11px] font-semibold text-white shadow-lg shadow-gray-900/20 transition hover:scale-[1.02]"
          >
...
function EmptyDay({ onAdd }: { onAdd: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-gray-200 bg-gray-50/60 px-6 py-16 text-center">
      ...
      <button
        onClick={onAdd}
        className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-primary px-4 py-2 text-[11px] font-semibold text-white transition hover:bg-primary-dim"
      >
        <CalendarPlus size={12} />
