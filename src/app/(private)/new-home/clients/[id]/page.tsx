  ...
  return (
    <div className="flex w-full flex-col gap-8">
      <MinimalHeader
        ...
        onBack={() => router.push("/new-home/clients")}
      />
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-gray-200 bg-white/50 px-6 py-16 text-center backdrop-blur-sm">
      ...
      <p className="mt-2 max-w-sm text-sm text-gray-500">
        Quando você gravar a próxima conversa com esse contato, ela vai
        aparecer aqui.
      </p>
      <div className="mt-6">
        <AudioRecorder
  ...
  return (
    <div className="relative overflow-hidden rounded-[24px] border border-gray-200/70 bg-gradient-to-br from-white via-white to-gray-50 p-5 shadow-[0_1px_2px_rgba(15,23,42,0.04)] md:p-7">
      ...
      <div className="relative flex flex-col gap-3">
        ...
        <p className="text-balance text-lg leading-relaxed font-medium text-gray-800 md:text-xl">
          {profile.signature}
        </p>
      </div>
    </div>
...
function buildMockProfile(client: ClientProps): MockProfile {
  ...
  return {
    ...
    tones: [
      { label: "Analítico", value: 38, color: "bg-indigo-500", bar: "bg-indigo-500" },
      { label: "Confiante", value: 26, color: "bg-emerald-500", bar: "bg-emerald-500" },
      { label: "Cético", value: 18, color: "bg-amber-500", bar: "bg-amber-500" },
      { label: "Curioso", value: 12, color: "bg-sky-500", bar: "bg-sky-500" },
      { label: "Impaciente", value: 6, color: "bg-rose-500", bar: "bg-rose-500" },
    ],
    topics: [
      "Metas do trimestre",
