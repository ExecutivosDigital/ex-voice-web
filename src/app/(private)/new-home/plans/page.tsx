...
const COMPARISON_ROWS: {
  ...
  { label: "Gravação de reuniões", values: ["Ilimitada", "Ilimitada", "Ilimitada"] },
  { label: "Transcrição por mês", values: ["150h", "Ilimitada", "Pool compartilhado"] },
          ...
          {(["PIX", "CREDIT"] as PaymentMethod[]).map((m) => {
            ...
            return (
              ...
              >
                ...
                <span className="relative">{m === "PIX" ? "PIX" : "Cartão"}</span>
              </button>
            );
          })}
        </div>
...
function ValuePanel({
  ...
  return (
    ...
    >
      ...
      <div>
        <h3 className="text-balance text-lg font-semibold text-gray-900 md:text-xl">
          Mais tempo pensando.{" "}
...
function TrustStrip() {
  const items = [
    { label: "Garantia 7 dias", value: "100%", hint: "satisfação ou reembolso" },
    ...
    <section className="grid grid-cols-2 gap-3 lg:grid-cols-4">
      {items.map((it) => (
        ...
        >
          ...
          <p className="mt-1 text-base font-semibold text-gray-900">{it.value}</p>
  ...
  return (
    <section className="flex flex-col gap-5">
      <div className="flex flex-col gap-1">
        ...
        <h2 className="text-balance text-xl font-semibold text-gray-900 md:text-2xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-0.5 text-xs text-white/60">
            Troque ou cancele sem burocracia. Sem contratos longos, sem pegadinhas.
          </p>
        </div>
      </div>
      <a
