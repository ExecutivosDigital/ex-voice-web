...
export function ImmersiveRecorder({ mode, onClose }: ImmersiveRecorderProps) {
  ...
  return createPortal(
    ...
    >
      ...
      <div className="pointer-events-none absolute top-6 left-6 z-10 flex items-center gap-2.5 opacity-90">
        <Image
          src="/logos/logo2.png"
          alt="Executivos"
          width={280}
          height={112}
          priority
          className="h-7 w-auto object-contain drop-shadow-[0_4px_12px_rgba(0,0,0,0.45)] md:h-8"
        />
      </div>
      ...
      <div
        className={cn(
          ...
          stage === "saveForm"
            ? "max-h-screen max-w-6xl overflow-y-auto px-6 py-8"
            : stage === "intro" && mode === "online"
              ? "max-w-[1400px] px-4 pt-20 pb-4 md:px-8"
              : "max-w-2xl px-6",
        )}
      >
        <AnimatePresence mode="wait">
          ...
          {stage === "intro" && mode === "online" && (
            ...
            >
              <div className="grid w-full items-stretch gap-4 md:grid-cols-[minmax(0,0.95fr)_minmax(0,1.15fr)] md:gap-6">
                <div className="flex flex-col items-center justify-center rounded-3xl border border-white/10 bg-white/[0.04] p-5 text-center shadow-[0_30px_80px_-30px_rgba(0,0,0,0.6)] backdrop-blur-xl md:p-7">
                  <div
                    className={cn(
                ...
                <div className="flex flex-col rounded-3xl border border-white/10 bg-white/[0.04] p-5 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.6)] backdrop-blur-xl md:p-6">
                  <div className="mb-3">
                  ...
                  {browserInfo.supportsTabAudio ? (
                    ...
                    <div className="mt-3 flex items-start gap-2 rounded-lg border border-amber-300/25 bg-amber-300/[0.08] px-3 py-2 text-[11px] leading-snug text-amber-100/90">
                      ...
                      <span>
                        ...
                        Abra esta página no Google Chrome, Edge, Brave ou
                        Opera.
                      </span>
                    </div>
                  )}
          ...
          {stage === "saveForm" && (
            <motion.div
              ...
              className="w-full text-left"
            >
              <div className="grid w-full items-stretch gap-6 md:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] md:gap-8">
              <div className="flex flex-col rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.6)] backdrop-blur-xl md:p-8">
                ...
                <div className="mb-5">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-white/30 transition focus:border-white/30 focus:bg-white/10 focus:ring-2 focus:ring-white/10 focus:outline-none"
                  />
                </div>
                ...
                <div className="mb-2">
                    ...
                    <div className="mb-3 flex flex-wrap gap-2">
                      {selectedContactIds.map((id) => {
                        ...
                        return (
                          <span
                            key={id}
                            className="flex items-center gap-1.5 rounded-full bg-emerald-300/15 py-1 pr-1.5 pl-3 text-xs font-medium text-emerald-100 ring-1 ring-emerald-300/30"
                          >
                            {c.name}
                            <button
                              type="button"
                              onClick={() => toggleContact(id)}
                              className="flex h-5 w-5 items-center justify-center rounded-full text-emerald-100/70 transition hover:bg-emerald-300/20 hover:text-white"
                  ...
                  <div className="mt-3 flex items-center gap-2">
                    <input
                      ...
                      placeholder="+ Cadastrar novo contato (digite o nome)"
                      className="flex-1 rounded-xl border border-dashed border-white/15 bg-transparent px-4 py-2.5 text-sm text-white placeholder:text-white/40 transition focus:border-white/40 focus:outline-none"
                    />
                    <button
                      type="button"
