...
const NAV_ITEMS: { label: string; href: string }[] = [
  { label: "Gravação", href: "/new-home" },
  { label: "Últimas Gravações", href: "/new-home/recordings" },
  { label: "Clientes", href: "/new-home/clients" },
  { label: "Agenda", href: "/new-home/agenda" },
];
              ...
              >
                ...
                <div className="p-1">
                  <DropdownMenuItem
                    ...
                    className="flex cursor-pointer items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm text-gray-700 transition focus:bg-gray-50 focus:outline-none hover:bg-gray-50"
                  >
                  ...
                  <DropdownMenuItem
                    ...
                    className="flex cursor-pointer items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm text-red-600 transition focus:bg-red-50 focus:outline-none hover:bg-red-50"
                  >
                    <LogOut size={16} />
                    Sair
                  </DropdownMenuItem>
