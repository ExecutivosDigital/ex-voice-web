    ...
    // ========== SEÇÃO: ORIENTAÇÕES E NOTAS ==========
    {
      ...
      components: [
        ...
        },
        {
          ...
          data: {
            notes:
              "Contato orientado sobre a importância da adesão ao tratamento farmacológico e não farmacológico. Discutido prognóstico e metas terapêuticas (PA < 130/80 mmHg). Contato verbalizou compreensão e concordou com plano proposto.",
          },
        },
      ],
    },
      ...
      components: [
        {
          ...
          data: {
            ...
            evolution: "Crônica",
            justification:
              "Contato apresenta histórico de pressão arterial elevada (150/90 mmHg) em múltiplas aferições, associado a cefaleia occipital e tontura ocasional. Histórico familiar positivo para doenças cardiovasculares e idade superior a 40 anos corroboram a hipótese.",
          },
        },
        {
          type: "symptoms_card",
