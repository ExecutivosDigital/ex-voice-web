        ...
        {(() => {
          ...
          return displayItems.map((item, idx) => {
            ...
            return (
              <div
                key={item.id || idx}
                className={`flex items-start gap-5 rounded-2xl border ${styles.border} bg-gradient-to-r ${styles.bg} to-white p-5 transition-all`}
              >
                {dateStr && (
                  <div
                    className={`flex min-w-[70px] flex-col items-center justify-center rounded-xl border ${styles.border} bg-white p-3`}
                  >
