...
> = {
  ...
  entities_card: EntitiesCard as React.ComponentType<CardComponentProps>,
  sentiment_card: SentimentCard as React.ComponentType<CardComponentProps>,
  chapters_card: ChaptersCard as React.ComponentType<CardComponentProps>,
