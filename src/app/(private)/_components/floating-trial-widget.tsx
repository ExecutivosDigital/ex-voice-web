  ...
  switch (tone) {
    ...
    case "danger":
      return {
        ...
        ringTo: "#f43f5e",
        glow: "bg-rose-300/30",
        chip: "bg-gradient-to-r from-rose-500 to-pink-500 text-white shadow-[0_6px_14px_-4px_rgba(244,63,94,0.5)]",
      };
    case "warn":
      return {
        ringFrom: "#fbbf24",
        ...
        chip: "bg-gradient-to-r from-amber-400 to-orange-500 text-white shadow-[0_6px_14px_-4px_rgba(245,158,11,0.55)]",
      };
    case "trial":
      return {
        ringFrom: "#111827",
...
export function FloatingTrialWidget() {
  ...
  if (collapsed) {
    return createPortal(
      <motion.button
        ...
        className="group z-[9998] flex h-14 w-14 items-center justify-center rounded-full border border-gray-200 bg-white/80 shadow-[0_16px_40px_-16px_rgba(15,23,42,0.25)] backdrop-blur-xl transition hover:scale-105 hover:shadow-[0_20px_48px_-16px_rgba(15,23,42,0.35)]"
  ...
  return createPortal(
    ...
    >
      <div
        className={cn(
          "pointer-events-none absolute -inset-3 rounded-[28px] opacity-80 blur-2xl",
          glow,
        )}
      />
      ...
      <div className="relative overflow-hidden rounded-[22px] border border-white/80 bg-white/75 p-4 shadow-[0_20px_50px_-20px_rgba(15,23,42,0.25),0_0_0_1px_rgba(15,23,42,0.02)] backdrop-blur-2xl">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-lg leading-none font-semibold text-gray-900 tabular-nums">
                  {isExpired ? (
                    "—"
                  ) : (
                    <>
        ...
        >
          <span className="absolute inset-0 animate-[shimmer_3s_ease-in-out_infinite] bg-[linear-gradient(110deg,transparent_25%,rgba(255,255,255,0.35)_50%,transparent_75%)] bg-[length:250%_100%]" />
