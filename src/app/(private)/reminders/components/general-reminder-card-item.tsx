    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-3 py-1">
          <div className="group-hover:bg-gray-50 flex items-center justify-between rounded-2xl bg-gray-50 p-4 transition-colors">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl bg-white px-3 py-2 text-[10px] font-bold text-gray-600 shadow-sm ring-1 ring-gray-100 transition-all hover:bg-gray-600 hover:text-white hover:ring-gray-600"
            >
        ...
        <div className="mt-auto flex items-center justify-between border-t border-gray-100 pt-5">
          ...
          <button
            onClick={handleNavigation}
            className="group-hover:bg-primary flex items-center gap-1.5 rounded-xl bg-gray-50 px-4 py-2 text-xs font-bold text-gray-600 transition-all duration-300 group-hover:text-white group-hover:shadow-lg group-hover:shadow-gray-500/25"
          >
            <span>Acessar</span>
