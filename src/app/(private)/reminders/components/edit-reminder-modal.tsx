                ...
                <form onSubmit={handleSave} className="flex flex-col gap-5">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-900 focus:border-gray-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-gray-500/10 transition-all"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-medium text-gray-900 focus:border-gray-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-gray-500/10 transition-all"
                                required
                            />
                        </div>
                        <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full resize-none rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-900 focus:border-gray-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-gray-500/10 transition-all"
                    ...
                    <div className="mt-2 flex gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex-1 rounded-2xl bg-gradient-to-r from-gray-600 to-gray-500 py-3.5 text-sm font-bold text-white shadow-lg shadow-gray-500/25 hover:shadow-gray-500/40 active:scale-95 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
                        >
                            {loading ? (
