      ...
      {pendingAudioFile && pendingAudioUrl && (
        <div className="mb-0 w-full min-w-[80%] max-w-[80%]">
          <WaveformAudioPlayer
            ...
            barCount={14}
            className="w-full border border-gray-200 bg-white py-1.5 pl-2 pr-2 shadow-sm [&_button]:h-6 [&_button]:w-6 [&_button]:bg-gray-50 [&_button]:text-gray-600 [&_button]:hover:bg-gray-100 [&_span]:text-gray-600 [&_span]:text-xs [&_svg]:h-3 [&_svg]:w-3 [&_svg]:fill-gray-600 [&_svg]:text-gray-600"
            videoDuration="00:00"
          />
