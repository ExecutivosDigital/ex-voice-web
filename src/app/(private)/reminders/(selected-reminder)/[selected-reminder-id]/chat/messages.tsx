  ...
  return (
    <div className="group/card mb-4 ml-2 flex max-w-[calc(100%-8px)] flex-col items-start justify-start gap-1 space-x-2 lg:mb-2 xl:mb-4 xl:max-w-[calc(100%-50px)] rtl:space-x-reverse">
      <div className="relative flex min-w-10 flex-col justify-center gap-1 rounded-2xl rounded-bl-none border border-gray-100 bg-white p-4 pr-10 text-gray-800 shadow-sm">
        ...
        <div className="prose prose-sm prose-a:text-gray-700 prose-a:no-underline hover:prose-a:underline prose-strong:text-gray-900 max-w-none break-words text-gray-800">
          <ReactMarkdown
      ...
      {message.role === "user" ? (
        message.type?.startsWith("audio") && message.file ? (
          <div className="group mr-2 mb-4 ml-auto flex max-w-[calc(100%-8px)] flex-col items-end justify-end gap-1 lg:mb-2 xl:mb-4 xl:max-w-[calc(100%-50px)]">
            <div className="flex min-w-10 flex-col gap-1 rounded-2xl rounded-br-none bg-gradient-to-r from-gray-600 to-gray-700 p-3 text-white shadow-sm shadow-gray-600/20">
              ...
              <div className="mt-2 w-full max-w-sm rounded-2xl bg-transparent">
                <WaveformAudioPlayer
                  ...
                  videoDuration="00:00"
                  barCount={24}
                  className="w-full border border-gray-200 bg-white shadow-sm [&_button]:bg-gray-50 [&_button]:text-gray-600 [&_button]:hover:bg-gray-100 [&_span]:font-bold [&_span]:text-gray-600 [&_svg]:text-gray-600"
                />
              </div>
            </div>
          ...
          <div className="group mr-2 mb-4 ml-auto flex max-w-[calc(100%-8px)] flex-col items-end justify-end gap-1 lg:mb-2 xl:mb-4 xl:max-w-[calc(100%-50px)]">
            <div className="flex min-w-10 justify-center gap-1 rounded-2xl rounded-br-none bg-gradient-to-r from-neutral-500 to-neutral-900 p-3 text-white shadow-sm shadow-gray-500/20">
