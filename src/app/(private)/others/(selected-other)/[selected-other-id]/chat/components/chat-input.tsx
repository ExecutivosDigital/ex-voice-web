...
export function ChatInput({
  ...
  return (
    <div className="mx-auto flex w-full flex-col items-center justify-center px-4 py-2 pb-1">
      ...
      {pendingAudioFile && pendingAudioUrl && (
        <div className="mb-0 w-full max-w-[80%] min-w-[80%]">
          <WaveformAudioPlayer
            ...
            barCount={14}
            className="w-full border border-neutral-100 bg-white py-1.5 pr-2 pl-2 shadow-sm [&_button]:h-6 [&_button]:w-6 [&_button]:bg-neutral-50 [&_button]:text-neutral-600 [&_button]:hover:bg-neutral-100 [&_span]:text-xs [&_span]:text-neutral-600 [&_svg]:h-3 [&_svg]:w-3 [&_svg]:fill-neutral-600 [&_svg]:text-neutral-600"
            videoDuration="00:00"
          />
      ...
      <div
        className={`invisible text-center text-xs text-gray-400 ${pendingAudioFile ? "mb-0" : "mb-1"}`}
      >
        ""
      </div>
      ...
      <div className="relative flex min-w-[80%] items-center gap-2 rounded-full border border-gray-200 bg-white px-4 py-3 shadow-sm transition-shadow focus-within:shadow-md">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={pendingAudioFile ? onDiscardAudio : handleMicClick}
