      ...
      return (
        ...
        >
          <WaveformAudioPlayer
            ...
            videoDuration="00:00"
            barCount={24}
            className="[ border border-gray-100 bg-white shadow-sm [&_button]:bg-gray-50 [&_button]:text-gray-600 [&_button]:hover:bg-gray-100 [&_span]:font-bold [&_span]:text-gray-600 [&_svg]:text-gray-600"
          />
        </div>
      );
    }
