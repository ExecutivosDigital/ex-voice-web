          ...
          <div className="flex flex-col gap-4 p-6">
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col gap-1">
                      {isEditing ? (
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            className="flex-1 rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-slate-700 outline-none ring-2 ring-gray-500/20 focus:border-gray-500"
                            placeholder="Nome do locutor"
                          />
                          <button
                            onClick={handleSaveEdit}
                            className="rounded-lg bg-gray-600 p-1.5 text-white hover:bg-gray-700"
                          >
                        ...
                        <div className="flex items-center gap-2">
                          <span
                            className={cn(
                              "text-sm font-medium",
                              isActive ? "text-gray-900" : "text-slate-700",
                            )}
                          >
                      ...
                      <span className="text-xs text-slate-400">
                        {isActive ? "Profissional" : "Contato/Outro"}
                      </span>
                    </div>
            ...
            <div className="flex items-center justify-between border-t border-slate-200 pt-4">
              ...
              <button
                ...
                disabled={isSaving}
                className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-gray-600 to-gray-600 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-gray-600/25 transition-all hover:shadow-xl hover:shadow-gray-600/30 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {isSaving ? (
                  <>
        ...
        <div className="flex w-full flex-row items-center justify-between border-b border-b-slate-200 px-4 pt-2 pb-2 bg-white flex-shrink-0">
          ...
          <div className="flex flex-1 items-center justify-end">
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-gray-600 to-gray-600 px-4 py-2 text-sm font-semibold text-white shadow-md shadow-gray-600/20 transition-all hover:shadow-lg hover:shadow-gray-600/30 active:scale-[0.98]"
            >
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        ...
                        isPro
                          ? "rounded-tr-none bg-gray-600 text-white"
