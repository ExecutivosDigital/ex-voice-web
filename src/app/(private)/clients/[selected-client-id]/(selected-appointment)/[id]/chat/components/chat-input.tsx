    ...
    <div className="mx-auto flex w-full flex-col items-center justify-center px-4 py-2 pb-1">
              ...
              return (
                <div key={fileKey} className="relative flex items-center pr-2">
                  <WaveformAudioPlayer
                    audioUrl={url}
                    barCount={20}
                    className="w-64 border border-gray-100 bg-white py-2 shadow-sm [&_button]:bg-gray-50 [&_button]:text-gray-600 [&_button]:hover:bg-gray-100 [&_span]:text-gray-600 [&_svg]:fill-gray-600 [&_svg]:text-gray-600"
                    videoDuration="00:00"
                  />
                  <button
      ...
      <div className="relative flex min-w-[80%] items-center gap-2 rounded-full border border-gray-200 bg-white px-4 py-3 shadow-sm transition-shadow focus-within:shadow-md">
        <button
          ...
          className="group text-primary relative flex h-8 w-8 items-center justify-center rounded-lg from-gray-500 to-gray-600 transition-all hover:scale-105 hover:bg-gradient-to-br hover:text-white active:scale-95"
