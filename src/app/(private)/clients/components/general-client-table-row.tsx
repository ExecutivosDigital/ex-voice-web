...
export function GeneralClientTableItem({ client }: Props) {
  ...
  return (
    <TableRow
      ...
      key={client.id}
      className="group h-20 cursor-pointer border-b border-gray-50 transition-all duration-200 hover:bg-gray-50/30"
    >
      ...
      <TableCell className="w-80 max-w-80 truncate py-0.5 text-start text-sm font-medium whitespace-nowrap">
        <TooltipProvider>
          ...
          >
            ...
            <TooltipContent
              className={cn(
                "border-gray-100 bg-white text-gray-700 shadow-xl",
