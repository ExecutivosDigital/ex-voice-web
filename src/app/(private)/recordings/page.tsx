    ...
    <div className="flex w-full flex-col gap-10">
      <section className="flex flex-col gap-2">
        ...
        <p className="mt-1 max-w-xl text-sm leading-relaxed text-gray-500">
          Tudo o que você gravou — buscável, organizado e pronto pra revisar com
          IA.
        </p>
      </section>
      ...
      <section>
        {isGettingRecordings ? (
          ...
          <EmptyState onCreate={() => router.push("")} hasFilters={!!query} />
        ) : (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        >
          <StatusIcon
            size={9}
            className={cn(status.label === "Transcrevendo" && "animate-spin")}
          />
          {status.label}
        </span>
      </div>
