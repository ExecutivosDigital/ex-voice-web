    ...
    return (
        <div className="relative w-full max-w-sm rounded-2xl border border-white/20 bg-white/10 p-8 backdrop-blur-lg shadow-2xl overflow-hidden">
            ...
            <motion.div
                ...
                className="absolute -top-20 -right-20 h-64 w-64 rounded-full bg-gray-500/20 blur-3xl pointer-events-none"
            />
            ...
            <div className="relative mb-8 flex items-center justify-between">
                <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                        ...
                        <p className="text-xs text-gray-200/70">Online & Criptografado</p>
                    </div>
                </div>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-center mb-1">
                                        ...
                                        {isActive && (
                                            <span className="text-[10px] font-semibold text-gray-300 bg-gray-500/10 px-1.5 py-0.5 rounded">
                                                PROCESSANDO
                                            </span>
                                        )}
                                    </div>
                                    <p className="text-xs text-gray-200/50">{step.desc}</p>
            ...
            >
                ...
                <span className="text-xs font-medium text-gray-200/80">
