...
/**
 * Componente de animação "Gravando Reunião"
 * Utiliza Framer Motion para as ondas de áudio e notificações.
 */
...
const SuccessNotification = () => (
    ...
    >
        ...
        <div>
            ...
            <p className="text-xs text-neutral-400">Resumo gerado em 3s</p>
        </div>
    </motion.div>
);
